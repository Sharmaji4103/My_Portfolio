...
// Dynamic code lines animation
function createCodeLine() {
    const codeLine = document.createElement('div');
    codeLine.className = 'code-line';
    codeLine.style.left = Math.random() * 100 + '%';
    codeLine.style.animationDelay = Math.random() * 5 + 's';
    codeLine.style.height = Math.random() * 300 + 200 + 'px';
    document.querySelector('.code-lines').appendChild(codeLine);
}

// Create additional code lines
for (let i = 0; i < 5; i++) {
    setTimeout(() => createCodeLine(), i * 1000);
}
